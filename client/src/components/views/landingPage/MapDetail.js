...
const MapDetail = () => {
    ...
    useEffect(() => {
        ...
        function searchPlaces() {
            console.log("keyword",searchText+"맛집")
           

            // 장소검색 객체를 통해 키워드로 장소검색을 요청합니다
            ps.keywordSearch(searchText+"맛집", placesSearchCB);
        ...
        function getListItem(index, places) {
            ...
            itemStr += '  <span class="tel">' + "Tel" + places.phone + '</span>' +
                '</div>';
        ...
        <>
            <div id="map" style={{ width: "500px", height: "400px" , position: "relative" }}></div>
                <div id="menu_wrap">
                    ...
                    <input type="button" onClick={btnClick} value="검색"/>
                    <hr/>
                    <ul id="placesList"></ul>
